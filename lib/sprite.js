...
const SimpleTowerSprite = require('./sprites/simple-tower');
const ContinuousFireTowerSprite = require('./sprites/continuous-fire-tower');
const HeavyDamageTowerSprite = require('./sprites/heavy-damage-tower');
const FlashTowerSprite = require('./sprites/flash-tower');
