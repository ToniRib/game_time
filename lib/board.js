...
Board.prototype.updateTileTypes = function () {
  ...
  } else if (this.lastTileIsHighlightedOrSelected() && this.currentTile && !this.currentTile.isBuildTile()) {
    this.lastTile.type = 'buildTile';
  } else if (this.currentTileIsAVacantBuildTile()) {
    this.currentTile.type = 'buildTileHighlighted';
  } else if ( this.currentTile && this.currentTile.isBuildTile()) {
    this.currentTile.type = 'buildTileSelected';
    if (this.lastTile && this.lastTile.isHighlightedBuildTile()) { this.lastTile.type = 'buildTile'; }
  }
};
