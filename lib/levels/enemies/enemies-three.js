...
let enemiesThree = {
  createEnemies: function() {
    return [
      ...
      new QuickEnemy({ x: -2375, y: 50 }),
      new QuickEnemy({ x: -2400, y: 50 }),
      new QuickEnemy({ x: -2425, y: 50 }),
      new QuickEnemy({ x: -2450, y: 50 })
    ];
  }
};
