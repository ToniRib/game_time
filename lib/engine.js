...
function drawTowers(ctx) {
  for (let tileTower of game.getTowerTiles()) {
    ...
    } else if (tileTower.tower.constructor.name === 'FlashTower') {
      ctx.drawImage(images.flashTower, tileTower.x, tileTower.y);
    } else if (tileTower.tower.constructor.name === 'HeavyDamageTower') {
      ctx.drawImage(images.heavyDamageTower, tileTower.x, tileTower.y);
    }
  }
}
