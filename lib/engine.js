...
function selectTile(event) {
  ...
  // lastTile = game.board.lastTile;
  // currentTile = game.board.currentTile;

  if (tileIsABuildTile(game.board.currentTile) && (tileIsAHighlightedBuildTile(game.board.lastTile) || tileIsASelectedBuildTile(game.board.lastTile)) && game.board.currentTile.vacant) {
    ...
    game.board.lastTile.type = 'buildTile';
    $('#sell-button').hide();
  } else if (tileIsABuildTile(game.board.currentTile) && game.board.currentTile.vacant) {
    game.board.currentTile.type = 'buildTileHighlighted';
    $('#sell-button').hide();
